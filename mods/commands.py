...
class Commands(Cog):
    ...
    async def die(self, ctx):
        ...
        await ctx.message.channel.send(embed=discord.Embed(description=emotes.Done + " " + self.user.name + " is now shutting down..." + ctx.message.author.mention, color=0x0035ff))
